...
cd %{_builddir}/Shapely-1.6.4.post2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583523306
...
cp %{_builddir}/Shapely-1.6.4.post2/LICENSE.txt %{buildroot}/usr/share/package-licenses/Shapely/eb14a25dd1cea155c4fa3e201dd54eee8bbb62eb
