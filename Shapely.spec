...
Source0  : https://files.pythonhosted.org/packages/42/f3/0e1bc2c4f15e05e30c6b99322b9ddaa2babb3f43bc7df2698efdc1553439/Shapely-1.7.1.tar.gz
...
%prep
%setup -q -n Shapely-1.7.1
cd %{_builddir}/Shapely-1.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625015313
...
cp %{_builddir}/Shapely-1.7.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/Shapely/eb14a25dd1cea155c4fa3e201dd54eee8bbb62eb
