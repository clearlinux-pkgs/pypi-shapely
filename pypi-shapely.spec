...
Version  : 1.8.3
Release  : 35
URL      : https://files.pythonhosted.org/packages/35/6d/ef38757796e756377be74bcae96c6283b21365afc96796c9d2b6ff6ddbe7/Shapely-1.8.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/35/6d/ef38757796e756377be74bcae96c6283b21365afc96796c9d2b6ff6ddbe7/Shapely-1.8.3.tar.gz
...
%prep
%setup -q -n Shapely-1.8.3
cd %{_builddir}/Shapely-1.8.3
pushd ..
cp -a Shapely-1.8.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660748184
...
cp %{_builddir}/Shapely-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-shapely/eb14a25dd1cea155c4fa3e201dd54eee8bbb62eb
