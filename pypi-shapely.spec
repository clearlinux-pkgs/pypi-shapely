...
Source0  : https://files.pythonhosted.org/packages/92/2e/a8bbe3c6b414c3c61c4b639ab16d5b1f9c4c4095817d417b503413e613c0/Shapely-1.8.5.post1.tar.gz
...
%prep
%setup -q -n Shapely-1.8.5.post1
cd %{_builddir}/Shapely-1.8.5.post1
pushd ..
cp -a Shapely-1.8.5.post1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665693188
